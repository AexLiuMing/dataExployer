            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <h4 className="subtitle is-size-3">{t('daistats.total_token', { token: 'USDT' })}</h4>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <h4 className="subtitle is-size-4">USDT Collateralization</h4>
                </div>
              </div>
              <div className="column">
                <div className="box has-text-centered">
                  <CollateralChart ilks={props.ilks} debt={props.debt} groupBy={true} />
                  <h4 className="subtitle is-size-4">USDT Generated by Collateral</h4>
                </div>
              </div>
            </div>
            <div className="columns">
