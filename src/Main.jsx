            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="title subtitle is-size-6">{t('daistats.initial_lot_size')}: {formatAmount.format(props.debtDump)} Dai</p>
            ...
            <div className="columns">
              <div className="column">
                <div className="box has-text-centered">
                  ...
                  <p className="title subtitle is-size-6">
                    <a rel="noopener noreferrer">Convert MKR to BKR with MKRbreak.io</a>
                  </p>
                </div>
              </div>
            </div>
